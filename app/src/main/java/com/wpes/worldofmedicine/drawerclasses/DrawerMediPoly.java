...
public class DrawerMediPoly extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_drawer_medi_poly);
        ...
        myWebView.loadUrl("http://prasadmedical.com/index.php/Home/web_view?id=2");
    }
    ...
    private void settingToolBar()  {
        Toolbar toolBar = (Toolbar) findViewById(R.id.toolbar);
        toolBar.setTitle("Medicine Policy");
